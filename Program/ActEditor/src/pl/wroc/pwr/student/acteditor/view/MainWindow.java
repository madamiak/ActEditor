...
//		Shell shell = new Shell(display);
		...
		fd_combo.top = new FormAttachment(0, 99);
		fd_combo.left = new FormAttachment(0, 10);
		fd_combo.right = new FormAttachment(100, -10);
		combo.setLayoutData(fd_combo);
		combo.add("Ustawa");
		combo.add("Rozporz¹dzenie");
		combo.add("Uchwa³a");
		combo.add("Zarz¹dzenie");
		combo.add("Informacja");
		combo.add("Komunikat");
		combo.add("Decyzja");
		combo.add("Oœwiadczenie");
		combo.add("Wyrok Trybuna³u Konstytucyjnego");
		combo.add("Postanowienie");
		combo.add("Wyrok");
		combo.add("Porozumienie");
		combo.add("Og³oszenie");
		...
		fd_btnUtwrz.right = new FormAttachment(100, -10);
