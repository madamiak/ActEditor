...
/**
 * Obs³uguje wyœwietlanie danych na ekranie.
 * 
 * @author Mateusz
 * 
 */
public class Presenter {
	...
	public void fill(Composite composite, TreeItem item) {
		...
		if (item.getText().equals("tytul") || item.getText().equals("srodtytul")
				|| item.getText().equals("element_redakcyjny") || item.getText().equals("preambula")
				|| item.getText().equals("czesc") || item.getText().equals("ksiega") || item.getText().equals("tyt")
				|| item.getText().equals("dzial") || item.getText().equals("rozdzial") || item.getText().equals("oddzial")
				|| item.getText().equals("artykul") || item.getText().equals("paragraf") || item.getText().equals("sentencja")
				|| item.getText().equals("ustep") || item.getText().equals("zaskarzenie") || item.getText().equals("punkt")
				|| item.getText().equals("litera") || item.getText().equals("tiret") || item.getText().equals("akapit"))
	...
	public void fillOutput(Tree treeOutput, Tree tree, Composite composite) {
		...
		TreeItem[] output = treeOutput.getItems();
		TreeItem old = null;
		while (!stack.isEmpty()) {
			boolean flag = false;
			TreeItem ti = (TreeItem) stack.pop();

			for (TreeItem out : output) {
			...
			old = new TreeItem(old, SWT.NONE);
			old.setText(ti.getText());
			Object c = elementRegistry.get(ti.getText());
...
//		xml.add(new Composition(ti.getText(), "all"));
	}
}
