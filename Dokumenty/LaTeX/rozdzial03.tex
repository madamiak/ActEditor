...
Twórca wtyczki ocenia, ¿e dziêki œrodowisku Eclipse z do³¹czon¹ wtyczk¹ J2S mo¿na poprawnie przet³umaczyæ nawet 90\% plików Ÿród³owych Java. Niestety wystêpuj¹ pewne rozbie¿noœci, miêdzy tymi dwoma jêzykami, których nie da siê rozwi¹zaæ. U¿ytkownicy wtyczki musz¹ np. pamiêtaæ, ¿e pola statyczne klasy mog¹ nie kompilowaæ siê poprawnie, typy prymitywne: \texttt{char, byte, short, int, long, float, double} s¹ traktowane jako \texttt{Number}, a tak¿e brak jest wsparcia dla w¹tków czy asynchronicznoœci.

\section{Java2Script a Java}

Bior¹c pod uwagê, ¿e stosowanie programowania obiektowego, które znamy z platformy Java, w JavaScript jest trudne i frustruj¹ce, autor Java2Script d¹¿y³ do tego, aby móc pisaæ aplikacje w jêzyku w pe³ni wspieraj¹cym OOP, jakim jest Java i u¿yæ go do tworzenia zorientowanych obiektowo skryptów JS.

Ze wzglêdu na ró¿nice pomiêdzy jêzykiem Java a JavaScript, wyniknê³y pewne ograniczenia stosowania tej technologii. J2S wspiera klasy wy³¹cznie z pakietów: \texttt{java.io}, \texttt{java.util}, \texttt{java.lang}, \texttt{java.lang.reflect}, \texttt{junit}, \texttt{org.eclipse.swt}. Trzeba jednak pamiêtaæ, ¿e niektóre klasy z wymienionych pakietów nie zosta³y zaimplementowane w Java2Script i nie mo¿na z nich skorzystaæ (TODO: odnoœnik do pe³nej listy wspieranych klas).

\section{System dziedziczenia w zanurzonym JavaScript}

Technologia J2S ma na celu konwersjê klas œrodowiska Java do skryptów JavaScript. Autor wtyczki zaznacza ró¿nice miêdzy podejœciem do programowania obiektowego w przypadku natywnego JavaScript w porównaniu do tego, jak OOP jest realizowane na platformie Java. Podstawowe ró¿nice to:
\begin{itemize}
