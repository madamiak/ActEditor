...
\begin{itemize}
	...
	\item[--] zaimplementowanie mechanizmu interfejsów,
...
Zasadê dzia³ania wtyczki w porównaniu do normalnego kompilatora Java pokazano na rys.~\ref{fig:j2s}. Po zainstalowaniu J2S mo¿na wybraæ, czy projekt ma byæ kompilowany z u¿yciem standardowego kompilatora, czy kompilatora Java2Script. Po wybraniu drugiej opcji dla ka¿dej klasy \texttt{.java} J2S utworzy plik \texttt{.js}. Zostanie te¿ wygenerowany plik \texttt{.html} dla ka¿dej klasy, posiadaj¹cej metodê \texttt{main()}. Do tego pliku do³¹czony zostanie powsta³y skrypt \texttt{.js}, który w swoim ciele mo¿e odwo³ywaæ siê do innych powsta³ych plików Ÿród³owych JavaScript. Plik w formacie HTML mo¿na otwieraæ w przegl¹darce internetowej, korzystaj¹c z nich jak z pe³ni funkcjonalnej aplikacji sieciowej.
...
Twórca wtyczki ocenia, ¿e dziêki œrodowisku Eclipse z do³¹czon¹ wtyczk¹ J2S mo¿na poprawnie przet³umaczyæ nawet 90\% plików Ÿród³owych Java \cite{J2SOOP}. Niestety, miêdzy tymi dwoma jêzykami wystêpuj¹ pewne rozbie¿noœci, których nie da siê rozwi¹zaæ. U¿ytkownicy wtyczki musz¹ np.\ pamiêtaæ, ¿e pola statyczne klasy mog¹ nie kompilowaæ siê poprawnie, typy prymitywne: \texttt{char, byte, short, int, long, float, double} s¹ traktowane jako \texttt{Number}, a tak¿e brak jest wsparcia dla w¹tków czy asynchronicznoœci.
...
\begin{itemize}
	...
	\item[--] idea konstruktorów w JavaScript jest niejasna, chyba ¿e za³o¿ymy, ¿e ka¿da funkcja mo¿e byæ rozpatrywana jako konstruktor,
...
\begin{figure}[h]
		...
		\caption{Interfejs u¿ytkownika aplikacji Karoo Lark Web Messenger (\url{http://karoolark.com/images/karoolark-web-messenger.jpg} dostêp z dnia 5 grudnia 2012r.)}
...
\begin{figure}[h]
		...
		\caption{Interfejs u¿ytkownika aplikacji Lemon Dove Web Mail Client (\url{http://lemondove.com/images/dove.png} dostêp z dnia 5 grudnia 2012r.)}
		\label{fig:web_mail}
	\end{figure}
	\begin{figure}[h]
		\centering
